...
const CARGOS_VALIDOS = ['jefatura','usuarios','supervisor','backoffice','asesor','validacion','grabaciones','seguimiento','cobranzas','calidad','supcalidad','backreclutamiento','asesorreclutamiento','entrevistas','capacitador','marketing'];
