...
const ESTADOS_VENTA = [
  ...
  { id:'no_validado',   label:'No Validado',      cls:'be-caida',      dot:'#ea580c' },
  ...
  { id:'caida',         label:'Caída',            cls:'be-caida',      dot:'#c2410c', bg:'#ffedd5', border:'1px solid rgba(248,113,113,.35)' },
  ...
  { id:'no_instalado',   label:'No Instalado',    cls:'be-caida',      dot:'#9a3412' },
  { id:'fraude',         label:'Fraude',          cls:'be-fraude',     dot:'#7c2d12', bg:'#fed7aa', border:'1px solid #f97316' },
  ...
  { id:'bloqueado',         label:'Bloqueado',         cls:'be-prog-bloqueado',   dot:'#c2410c', bg:'#ffedd5', border:'1px solid rgba(248,113,113,.5)' },
...
const TIPIF_COLORS = {
  ...
  'BUZON DE VOZ':'#78350f','SERVICIO ACTIVO':'#4b5563','SIN COBERTURA':'#c2410c','NO CALIFICA':'#9a3412',
  'CONTACTO CON TERCEROS':'#047857','EDIFICIO NO LIBERADO':'#9a3412','DESEA MOVIL':'#92400e','EN EJECUCION':'#4b5563','NO ROTAR':'#980000',
}
const COLORES_AV = ['#3b82f6','#8b5cf6','#22c55e','#f97316','#f97316','#06b6d4','#ec4899','#f59e0b']
          ...
          <section className={`section${seccion==='ventas'?' active':''}`}>
            ...
            {panelNV && (
              <div style={{background:'#fff',border:'1.5px dashed #e5e7eb',borderRadius:14,padding:'18px 20px',marginBottom:14}}>
                <div style={{fontSize:11,fontWeight:700,color:'#f97316',textTransform:'uppercase',letterSpacing:.7,marginBottom:14}}>+ Registrar nueva venta</div>
