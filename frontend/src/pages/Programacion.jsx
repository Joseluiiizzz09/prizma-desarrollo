...
export default function Programacion() {
  ...
  return (
    <div className="programacion-shell">
      ...
      <style>{`
        .be-bloqueado  { background:#ffedd5;color:#9a3412;border:none;border-radius:8px;padding:8px 14px;font-size:12px;font-weight:700;font-family:inherit;cursor:pointer; }
        ...
        .b-bloqueado  { background:#ffedd5;color:#9a3412; }
