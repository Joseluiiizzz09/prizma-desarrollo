...
const CARGO_CLASE = {
  ...
  seguimientolectura: 'bc-seguimiento',
                  ...
                  <tr key={u.id}>
                    ...
                    <td>
                      {u.activo
                        ...
                        : <span style={{ display: 'inline-flex', padding: '3px 9px', borderRadius: '6px', fontSize: '10px', fontWeight: 700, background: '#ffedd5', color: '#9a3412' }}>Inactivo</span>
                      }
                    </td>
          ...
          <div className="modal-card" style={{ maxWidth: '420px' }}>
            ...
            <div className="modal-body">
              <p style={{ fontSize: '14px', color: '#374151', textAlign: 'center', padding: '10px 0' }}>
                ...
                <strong style={{ color: '#ea580c' }}>{modalElim.nombre}</strong>?<br />
