    ...
    <div>
      <div className="topbar module-topbar-standard">
        ...
        <div className="topbar-right">
          ...
          <CambiarAreaMenu />
          <button className="btn-cancelar-m" style={{ borderColor: '#fdba74', color: '#f97316' }} onClick={salir}>Salir</button>
        </div>
      </div>
              ...
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                {(modalRevisar.estadoRev === 'programado'
                  ? [
                      ...
                      { id: 'no_conforme',  label: 'NO CONFORME',  border: '#fdba74', bg: '#fff7ed', color: '#c2410c' },
                      { id: 'rechazado',     label: 'RECHAZADO',     border: '#fb923c', bg: '#fff7ed', color: '#c2410c' },
                    ]
