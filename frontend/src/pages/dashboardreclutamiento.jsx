      ...
      <div className={`pantalla${tab !== 'ventassubidas' ? ' hidden' : ''}`}>
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'14px',flexWrap:'wrap',gap:'10px'}}>
          ...
          <button onClick={abrirNuevaVenta}
            style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'10px 22px',background:'linear-gradient(135deg,#f97316,#fb923c)',color:'#fff',border:'none',borderRadius:'12px',fontSize:'13px',fontWeight:700,fontFamily:'inherit',cursor:'pointer',boxShadow:'0 4px 14px rgba(249,115,22,.35)'}}>
            Nuevo Postulante
          </button>
        </div>
          ...
          <div className="modal-content" style={{minWidth:'320px',maxWidth:'380px',borderRadius:'16px'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'4px',marginBottom:'20px'}}>
              ...
              <input
                ...
                style={{padding:'10px 12px',border:`1.5px solid ${mvDniError ? '#f97316':'#e5e7eb'}`,borderRadius:'8px',fontSize:'15px',fontFamily:'monospace',outline:'none',background:'#fafafa',color:'#111827',letterSpacing:'2px',transition:'border .2s'}}
              />
            </div>
